...
public class SortCustomerOrders : SortBase<Domain.Entities.OrderAggregate.Order>
{
    public SortCustomerOrders(string? sortBy, string? orderBy) : base(sortBy, orderBy)
    {
    }
